-- ============================================================================
-- Migration 058: Update explore RPCs to include listing images
-- ============================================================================
-- Replaces get_bumped_listings and get_explore_listings to include an
-- images array (JSON) for each listing from the listing_images table.
-- ============================================================================

-- Drop existing functions first (return type changed — adding images column)
DROP FUNCTION IF EXISTS get_bumped_listings(text, integer);
DROP FUNCTION IF EXISTS get_explore_listings(text, text, integer, integer);

-- 1. BUMPED LISTINGS — now with images
...
-- 2. EXPLORE LISTINGS — now with images
