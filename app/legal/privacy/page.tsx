  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] pb-24">
      <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-gray-200 bg-[#fafbfc]/90 px-4 py-3 backdrop-blur-xl">
        ...
        <span className="text-[15px] font-semibold text-slate-800">Privacy Policy</span>
      </header>
      ...
      <div className="mx-auto max-w-2xl px-5 pt-8 space-y-8 text-[14px] leading-relaxed text-slate-600">
        <div>
          ...
          <h1 className="text-[22px] font-bold text-slate-800">Privacy Policy</h1>
          <p className="mt-2">
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">1. Information We Collect</h2>
          <h3 className="text-[14px] font-medium text-slate-700">Account Information</h3>
          <p>
          ...
          <h3 className="text-[14px] font-medium text-slate-700">Content You Post</h3>
          <p>
            Photos, captions, listings, comments, and messages you create on the platform.
          </p>
          <h3 className="text-[14px] font-medium text-slate-700">Usage Data</h3>
          <p>
          ...
          <h3 className="text-[14px] font-medium text-slate-700">Location Data</h3>
          <p>
          ...
          <h3 className="text-[14px] font-medium text-slate-700">Identity Verification</h3>
          <p>
          ...
          <h3 className="text-[14px] font-medium text-slate-700">Payment Information</h3>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">2. How We Use Your Information</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">3. Information Sharing</h2>
          <p>We do not sell your personal information. We may share data with:</p>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-slate-700">Service providers:</strong> Supabase (database/auth),
              Stripe (payments), Persona (verification), and hosting providers
            </li>
            <li>
              <strong className="text-slate-700">Law enforcement:</strong> When required by law
              or to protect safety
            </li>
            <li>
              <strong className="text-slate-700">Other users:</strong> Your public profile, posts,
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">4. Data Retention</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">5. Data Security</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">6. Your Rights</h2>
          ...
          <p>
            ...
            <span className="text-pink-500">privacy@cleopatra.app</span>.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">7. Cookies & Tracking</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">8. Children&apos;s Privacy</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">9. Changes to This Policy</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-slate-800">10. Contact</h2>
          <p>
