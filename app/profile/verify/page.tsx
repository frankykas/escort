...
const STEPS = [
  ...
  },
  {
    icon: Camera,
    title: "Face match",
    description: "A quick selfie to confirm the ID belongs to you. Powered by Yoti's secure liveness check.",
  },
  {
    icon: ShieldCheck,
    ...
    <div className="min-h-screen bg-zinc-950 pb-24">
      ...
      <div className="mx-auto max-w-lg px-4 pt-8 space-y-8">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div>
            <h1 className="text-[22px] font-bold text-white">Get Verified</h1>
        ...
        <div className="flex gap-3 rounded-2xl border border-white/5 bg-zinc-900/50 px-4 py-4">
          ...
          <p className="text-[12px] text-zinc-500 leading-relaxed">
            Your ID is processed by Yoti's secure identity platform. Cleopatra never stores your raw ID documents. Only a verification result is retained.
          </p>
        </div>
