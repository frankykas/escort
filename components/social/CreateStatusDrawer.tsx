    ...
    <>
      ...
      >
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/5 bg-zinc-900/80 px-5 py-4 backdrop-blur-xl">
          ...
          <span className="text-sm font-semibold text-zinc-100">New Status</span>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-5 p-5">
            ...
            <div className="mt-1 flex justify-end">
              <span
                className={cn(
                  ...
                  charsLeft <= 30 ? "text-amber-400" : "text-zinc-600"
                )}
              >
          ...
          <div className="flex gap-3 pb-2">
            ...
            <button
              ...
              disabled={!canPost}
              className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-white py-3 text-sm font-semibold text-zinc-950 transition-colors hover:bg-zinc-200 disabled:cursor-not-allowed disabled:opacity-40"
            >
              {isUploading ? (
                <>
